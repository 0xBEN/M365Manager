function Search-GroupStartsWith {
    ...
    $azureAdDynamicGroup = Get-AzureADMSGroup -All:$true -Filter "groupTypes/any(c:c eq 'DynamicMembership') and startswith(DisplayName,'$String')"
